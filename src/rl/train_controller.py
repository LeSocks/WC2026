...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train an observable team-controller policy.")
    ...
    config = {
        ...
        "resume": args.resume,
        "mode": "team_controller_tabular_q",
    }
    ...
    _, result = trainer.train_team_controller(
        env,
        episodes=args.episodes,
        max_steps=args.max_steps,
        logger=logger,
    ...
    print(f"Training complete: episodes={result.completed_episodes}, mean_reward={result.mean_reward:.4f}")
